...
urlpatterns = [
    ...
    path('AddCourse/validate_addcourse/',views.validate_addcourse,name='Validate_addcourse'),
    path('DeptEdit/validate_dept_edit/',views.validate_dept_edit,name='validate_dept_edit'),
    path('upload/',views.upload,name='upload'),    path('upload/',views.upload,name='upload'),
    path('Studrpt/',views.studReport,name='Studrpt'),
]
